...
extension PolygonCoordinates: GeoValueConvertible {
...
extension Polygon: GeoValueConvertible {
    /// Converts this object to an embeddable BSONPrimtive
    public func makePrimitive() -> BSON.Primitive {
        return ["type":self.type.rawValue, "coordinates":self.coordinates as Primitive] as Document
    }
}
